...
/// <summary>
/// کلاس کمکی برای encode/decode کردن اعداد صحیح در HPACK
/// طبق RFC 7541 Section 5.1
/// </summary>
public static class HpackInteger
{
    /// <summary>
    /// Encode کردن یک عدد صحیح با prefix طبق HPACK
    /// </summary>
    /// <param name="value">مقدار برای encode</param>
    /// <param name="prefixBits">تعداد بیت‌های موجود (1-8)</param>
    /// <param name="prefixMask">مقدار اولیه برای بایت اول (بیت‌های prefix)</param>
    ...
    /// <summary>
    /// Decode کردن یک عدد صحیح از buffer
    /// </summary>
    /// <returns>(decoded value, bytes consumed)</returns>
